import 'package:flamedemo/grossary/checkout_screen.dart';
...
class Cart extends State<Cart_screen> {
  List<Item> itemList = <Item>[
    ...
    Item(
        ...
        itemPrice: '\₹ 112'),
    Item(
        itemImage: 'assets/images/guava.jpg',
        itemName: 'Guava',
        itemQun: 'Qty:2',
        itemPrice: '\₹ 105'),
    Item(
        itemImage: 'assets/images/kiwi.jpg',
        itemName: 'Kiwi',
        itemQun: 'Qty:1',
        itemPrice: '\₹ 90'),
    Item(
        itemImage: 'assets/images/lemons.jpg',
        itemName: 'Lemon',
        itemQun: 'Qty:2',
        itemPrice: '\₹ 70'),
    Item(
