// import 'package:flamedemo/grossary/Cart_Screen.dart';
import 'package:flamedemo/grossary/help_screen.dart';
import 'package:flamedemo/grossary/item_screen.dart';
import 'package:flamedemo/grossary/logind_signup.dart';
import 'package:flamedemo/grossary/orderhistory_screen.dart';
import 'package:flamedemo/grossary/setting_screen.dart';
...
class home extends State<Home_screen> {
  ...
  List<Photo> photos = <Photo>[
    Photo(
      assetName: 'assets/images/veg.jpg',
      title: 'Fruits & Vegetables',
    ),
    Photo(
      assetName: 'assets/images/frozen.jpg',
      title: 'Frozen Veg',
    ),
    Photo(
      assetName: 'assets/images/bev.jpg',
      title: 'Beverages',
    ),
    Photo(
      assetName: 'assets/images/brand_f.jpg',
      title: 'Brannded Food',
    ),
    Photo(
      assetName: 'assets/images/be.jpg',
      title: 'Beauty & Personal Care',
    ),
    Photo(
      assetName: 'assets/images/home.jpg',
      title: 'Home Care & Fashion',
    ),
    Photo(
      assetName: 'assets/images/nonveg.jpg',
      title: 'Non Veg',
    ),
    Photo(
      assetName: 'assets/images/eggs.jpg',
          ...
          children: <Widget>[
            new Card(
              child: UserAccountsDrawerHeader(
               ...
               //   image: new ExactAssetImage('assets/assets/images/lake.jpeg'),
                  fit: BoxFit.cover,
                ),*/
                ),
                currentAccountPicture: CircleAvatar(
                    backgroundImage: NetworkImage(
                        "https://www.fakenamegenerator.com/assets/images/sil-female.png")),
              ),
            ),
            new Card(
              elevation: 4.0,
